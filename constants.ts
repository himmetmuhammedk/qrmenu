...
export const MENU_ITEMS: MenuItem[] = [
  ...
  // TATLILAR
  { id: 't1', categoryId: CategoryId.TATLILAR, name: 'Helvadere', description: 'Özel sunumlu helva tatlısı.', price: 75 },
  { id: 't2', categoryId: CategoryId.TATLILAR, name: 'Sütlaç', description: 'Fırınlanmış sütlaç.', price: 65 },
  { id: 't3', categoryId: CategoryId.TATLILAR, name: 'Hasandağı Zirvesi', description: 'Özel spesiyal tatlı.', price: 150 },
  { id: 't4', categoryId: CategoryId.TATLILAR, name: 'Trileçe', description: 'Karamel soslu sütlü tatlı.', price: 80 },
  { id: 't5', categoryId: CategoryId.TATLILAR, name: 'Revani', description: 'Şerbetli irmik tatlısı.', price: 65 },
  { id: 't6', categoryId: CategoryId.TATLILAR, name: 'Güz Güneşi', description: 'Mevsim meyveleri ile hafif tatlı.', price: 65 },
  { id: 't7', categoryId: CategoryId.TATLILAR, name: 'Güllaç', description: 'Ramazan klasiği, cevizli ve sütlü.', price: 65 },
  { id: 't8', categoryId: CategoryId.TATLILAR, name: 'Kalburabastı', description: 'Cevizli şerbetli tatlı.', price: 65 },
  { id: 't9', categoryId: CategoryId.TATLILAR, name: 'Profiterol', description: 'Çikolata soslu klasik lezzet.', price: 150 },
  { id: 't10', categoryId: CategoryId.TATLILAR, name: 'İncim', description: 'Hafif sütlü tatlı.', price: 120 },
  { id: 't11', categoryId: CategoryId.TATLILAR, name: 'Lattem', description: 'Kahve aromalı tatlı.', price: 100 },
  { id: 't12', categoryId: CategoryId.TATLILAR, name: 'İncelek', description: 'Geleneksel lezzet.', price: 70 },
  { id: 't13', categoryId: CategoryId.TATLILAR, name: 'Kadayıf Burma', description: 'Fıstıklı burma kadayıf.', price: 175 },
  { id: 't14', categoryId: CategoryId.TATLILAR, name: 'Magnolya', description: 'Muzlu ve çilekli seçenekleriyle.', price: 65 },

  // PASTALAR
  { id: 'p1', categoryId: CategoryId.PASTALAR, name: 'Rulo Pasta', description: 'Meyveli rulo pasta.', price: 110 },
  { id: 'p2', categoryId: CategoryId.PASTALAR, name: 'Mozaik Pasta', description: 'Klasik bisküvili mozaik pasta.', price: 80 },
  { id: 'p3', categoryId: CategoryId.PASTALAR, name: 'Balbadem', description: 'Bal ve bademli özel pasta.', price: 140 },
  { id: 'p4', categoryId: CategoryId.PASTALAR, name: 'Sultanhanı', description: 'Fıstıklı özel yapım pasta.', price: 160 },
  { id: 'p5', categoryId: CategoryId.PASTALAR, name: 'Ekler', description: 'Çikolatalı ve kremalı ekler (Adet).', price: 25 },
  { id: 'p6', categoryId: CategoryId.PASTALAR, name: 'Eğri Minare', description: 'Şekilli özel tasarım pasta.', price: 200 },
  { id: 'p7', categoryId: CategoryId.PASTALAR, name: 'Aşıklı Höyük', description: 'Katmanlı özel pasta.', price: 170 },
  { id: 'p8', categoryId: CategoryId.PASTALAR, name: 'Ekecik', description: 'Çikolata ve meyve uyumu.', price: 170 },
  { id: 'p9', categoryId: CategoryId.PASTALAR, name: 'Profesör Pasta', description: 'Yoğun çikolatalı pasta.', price: 120 },
  { id: 'p10', categoryId: CategoryId.PASTALAR, name: 'Sarıkaraman', description: 'Limonlu ve meyveli pasta.', price: 200 },
